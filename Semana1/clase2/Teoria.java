...
public class Teoria {
	...
	public static class Usuario {
		...
		public String determinarCategoriaMonotributo(int ingresos, int superficie, int energia) {
			if (ingresos < categoria_A.maxIIBB && superficie < categoria_A.maxSuperficie
					&& energia < categoria_A.maxEnergia) {
				return "CATEGORIA A";
			} else if (ingresos < categoria_B.maxIIBB && superficie < categoria_B.maxSuperficie
					&& energia < categoria_B.maxEnergia) {
				return "CATEGORIA B";
			} else if (ingresos < categoria_C.maxIIBB && superficie < categoria_C.maxSuperficie
					&& energia < categoria_C.maxEnergia) {
				return "CATEGORIA C";
			} else if (ingresos < categoria_D.maxIIBB && superficie < categoria_D.maxSuperficie
					&& energia < categoria_D.maxEnergia) {
				return "CATEGORIA D";
			} else if (ingresos < categoria_E.maxIIBB && superficie < categoria_E.maxSuperficie
					&& energia < categoria_E.maxEnergia) {
				return "CATEGORIA E";
			} else if (ingresos < categoria_F.maxIIBB && superficie < categoria_F.maxSuperficie
					&& energia < categoria_F.maxEnergia) {
				return "CATEGORIA F";
			}

			else if (ingresos < categoria_G.maxIIBB || superficie < categoria_G.maxSuperficie
					|| energia < categoria_G.maxEnergia) {
				return "CATEGORIA G";
			} else
				return "CATEGORIA H";
		}
