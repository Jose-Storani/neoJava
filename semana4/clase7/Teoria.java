...
public class Teoria {
	...
	//SUPER: en el constructor, llama al constructor del padre. Dentro de un metodo, se puede llamar a super.metodo, para llamar a algun metodo del padre.
	
	
	//INTERFACES: Son contratos entre clases. Lo que quiere decir, es que la clase debe implementar o poseer los metodos y atributos que se declaran en la interface. Sirven para darle forma 
